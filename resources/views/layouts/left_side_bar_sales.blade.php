        ...
        <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
            ...
            <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                <div id="kt_aside_menu" class="kt-aside-menu  kt-aside-menu--dropdown " data-ktmenu-vertical="1" data-ktmenu-dropdown="1" data-ktmenu-scroll="0">
                    ...
                    <li class="kt-menu__item  kt-menu__item--parent kt-menu__item--submenu-fullheight" aria-haspopup="true"><span class="kt-menu__link"><a href="{{ url('/sales') }}"><span class="">Contact</span></a></span></li>
                    <li class="kt-menu__item  " aria-haspopup="true"><span class="kt-menu__link"><a href="{{ url('/opportunitylist') }}"><span class="">Opportunity</span></a></span></li>
                    <li class="kt-menu__item " aria-haspopup="true"><span class="kt-menu__link"><a href="{{ url('/leadlist') }}"><span class="">Leads</span></a></span></li>
                    <li class="kt-menu__item  " aria-haspopup="true"><span class="kt-menu__link"><span class="">Reminder</span></span></li>
                    <li class="kt-menu__item " aria-haspopup="true"><span class="kt-menu__link"><span class="">Notes</span></span></li>
